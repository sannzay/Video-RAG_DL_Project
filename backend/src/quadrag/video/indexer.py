...
class VideoIndexer:
    ...
    def create_domain_index(
        ...
        try:
            ...
            # Since we disabled image index creation, frames_view will never exist
            logger.warning(f"Domain Index creation disabled: Image index not available (frames_view never created)")
